...
const easyScenes = ["assets/images/scene-easy-deposit.png", "assets/images/scene-easy-timer.png", "assets/images/scene-easy-popular.png"];
const hardScenes = ["assets/images/scene-hard-bonus.png", "assets/images/scene-hard-multis.png", "assets/images/scene-hard-personalised.png"];
const productPreviews = {
  easy: ["assets/images/ui-deposit-withdraw.png", "assets/images/ui-countdown.png", "assets/images/ui-popular-bets.png"],
  hard: ["assets/images/ui-bonus-offer.png", "assets/images/ui-multibets.png", "assets/images/ui-personalised.png"]
};
...
function groVisual(mood="neutral",label="GRO Analysis"){
  const src = {
    neutral:"assets/images/gro-neutral.svg",
    excited:"assets/images/gro-excited.svg",
    warning:"assets/images/gro-warning.svg"
  }[mood] || "assets/images/gro-neutral.svg";
...
function renderRegulatoryImage(){
  layout(`<section class="screen crisis-clean-screen">
    <div class="crisis-clean-hero">
      <img src="assets/images/crisis-background-clean-v2.png" alt="Regulatory officers raid the BetPeak CEO office" class="crisis-clean-bg">
...
function evaluateEnding(){ if(state.crisisTriggered && state.metrics.risk>=65) return "regulatory"; if(state.metrics.trust>=70 && state.metrics.risk<=40 && state.darkScore<=2) return "sustainable"; return "cost"; }
const endings={
  sustainable:{title:"Sustainable Challenger",badge:"Stable growth",board:"BetPeak grew without exhausting customer confidence. Investors wanted more speed, but the company enters the next year with room to expand and limited regulatory pressure.",summary:"You protected customer control while still building a competitive platform."},
  cost:{title:"Growth at a Cost",badge:"Commercial success · rising pressure",board:"The growth strategy delivered strong commercial results, but customer confidence weakened and public scrutiny increased. BetPeak survives, although the next year begins under pressure.",summary:"Short-term growth was achieved by increasing pressure, asymmetry or behavioural targeting."},
