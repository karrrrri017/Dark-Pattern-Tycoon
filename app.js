...
function renderCrisisIntro(){ layout(`<section class="screen image-screen contain"><img src="assets/event-celebrity-criticism.png" alt="Public criticism of BetPeak creates a business crisis"><div class="overlay-action"><button class="primary" data-action="handle">Handle crisis</button></div></section>`,{bare:true}); bind("[data-action='handle']",renderCrisisChoice); }
